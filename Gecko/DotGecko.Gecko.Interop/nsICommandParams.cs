...
{
	public static class nsICommandParamsConstants
	{
		/*
		 * List of primitive types for parameter values.
		 */
		public const Int16 eNoType = 0;      /* Only used for sanity checking */
		public const Int16 eBooleanType = 1;
		public const Int16 eLongType = 2;
		public const Int16 eDoubleType = 3;
		public const Int16 eWStringType = 4;
		public const Int16 eISupportsType = 5;
		public const Int16 eStringType = 6;
	}
	...
	public interface nsICommandParams //: nsISupports
	{
		/*
		 * getValueType
		 * 
