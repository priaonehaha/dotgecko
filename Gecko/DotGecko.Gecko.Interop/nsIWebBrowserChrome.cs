...
namespace DotGecko.Gecko.Interop
{
	...
	{
		public const UInt32 STATUS_SCRIPT = 0x00000001;
		public const UInt32 STATUS_SCRIPT_DEFAULT = 0x00000002;
		public const UInt32 STATUS_LINK = 0x00000003;

		/**
		 * Definitions for the chrome flags
		 */
		public const UInt32 CHROME_DEFAULT = 0x00000001;
		public const UInt32 CHROME_WINDOW_BORDERS = 0x00000002;
		public const UInt32 CHROME_WINDOW_CLOSE = 0x00000004;
		public const UInt32 CHROME_WINDOW_RESIZE = 0x00000008;
		public const UInt32 CHROME_MENUBAR = 0x00000010;
		public const UInt32 CHROME_TOOLBAR = 0x00000020;
		public const UInt32 CHROME_LOCATIONBAR = 0x00000040;
		public const UInt32 CHROME_STATUSBAR = 0x00000080;
		public const UInt32 CHROME_PERSONAL_TOOLBAR = 0x00000100;
		public const UInt32 CHROME_SCROLLBARS = 0x00000200;
		public const UInt32 CHROME_TITLEBAR = 0x00000400;
		public const UInt32 CHROME_EXTRA = 0x00000800;

		// createBrowserWindow specific flags
		public const UInt32 CHROME_WITH_SIZE = 0x00001000;
		public const UInt32 CHROME_WITH_POSITION = 0x00002000;

		// special cases
		public const UInt32 CHROME_WINDOW_MIN = 0x00004000;
		public const UInt32 CHROME_WINDOW_POPUP = 0x00008000;

		public const UInt32 CHROME_WINDOW_RAISED = 0x02000000;
		public const UInt32 CHROME_WINDOW_LOWERED = 0x04000000;
		public const UInt32 CHROME_CENTER_SCREEN = 0x08000000;
		...
		// dependent.
		public const UInt32 CHROME_DEPENDENT = 0x10000000;

		// Note: The modal style bit just affects the way the window looks and does
		//       mean it's actually modal.
		public const UInt32 CHROME_MODAL = 0x20000000;
		public const UInt32 CHROME_OPENAS_DIALOG = 0x40000000;
		public const UInt32 CHROME_OPENAS_CHROME = 0x80000000;

		public const UInt32 CHROME_ALL = 0x00000ffe;
	}
