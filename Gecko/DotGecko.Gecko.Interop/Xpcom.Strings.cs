...
namespace DotGecko.Gecko.Interop
{
	public static partial class Xpcom
	{
		...
		public const UInt32 NS_STRING_CONTAINER_INIT_DEPEND = (1 << 1);
		...
		public const UInt32 NS_STRING_CONTAINER_INIT_ADOPT = (1 << 2);

		/* Data passed into NS_StringContainerInit2 is a substring that is not
		 * null-terminated. */
		public const UInt32 NS_STRING_CONTAINER_INIT_SUBSTRING = (1 << 3);
		...
		public static extern nsResult NS_StringContainerInit(AStringContainer aContainer);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Unicode)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_StringSetData(AString aStr, String aData, UInt32 aDataLength);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Unicode)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_StringSetDataRange(AString aStr, UInt32 aCutOffset, UInt32 aCutLength, String aData, UInt32 aDataLength);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Unicode)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_StringCopy(AString aDestStr, AString aSrcStr);
		 ...
		 */
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Unicode)]
		public static extern void NS_StringSetIsVoid(AString aStr, Boolean aIsVoid);
		 ...
		 */
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Unicode)]
		public static extern Boolean NS_StringGetIsVoid(AString aStr);
		...
		public const UInt32 NS_CSTRING_CONTAINER_INIT_DEPEND = (1 << 1);

		/* Data passed into NS_CStringContainerInit2 is not copied; instead, the
		 * string takes ownership over the data pointer.  The caller must have
		 * allocated the data array using the XPCOM memory allocator (nsMemory).
		 * This flag should not be combined with NS_CSTRING_CONTAINER_INIT_DEPEND. */
		public const UInt32 NS_CSTRING_CONTAINER_INIT_ADOPT = (1 << 2);

		/* Data passed into NS_CStringContainerInit2 is a substring that is not
		 * null-terminated. */
		public const UInt32 NS_CSTRING_CONTAINER_INIT_SUBSTRING = (1 << 3);
		...
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringContainerInit(ACStringContainer aContainer);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringContainerInit2(ACStringContainer aContainer, String aData, UInt32 aDataLength, UInt32 aFlags);

		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringContainerInit2(ACStringContainer aContainer, Byte[] aData, UInt32 aDataLength, UInt32 aFlags);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringSetData(ACString aStr, String aData, UInt32 aDataLength);

		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringSetData(ACString aStr, Byte[] aData, UInt32 aDataLength);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringSetDataRange(ACString aStr, UInt32 aCutOffset, UInt32 aCutLength, String aData, UInt32 aDataLength);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringCopy(ACString aDestStr, ACString aSrcStr);
		 ...
		 */
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		public static extern void NS_CStringSetIsVoid(ACString aStr, Boolean aIsVoid);
		 ...
		 */
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true, CharSet = CharSet.Ansi)]
		public static extern Boolean NS_CStringGetIsVoid(ACString aStr);

		/**
		 * Encodings that can be used with the following conversion routines.
		 */
		public enum nsCStringEncoding : uint
		{
		...
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_CStringToUTF16(ACString aSource, nsCStringEncoding aSrcEncoding, AString aDest);
		...
		[DllImport(xpcom, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, PreserveSig = true)]
		[return: MarshalAs(UnmanagedType.U4)]
		public static extern nsResult NS_UTF16ToCString(AString aSource, nsCStringEncoding aDestEncoding, ACString aDest);
	}
}
