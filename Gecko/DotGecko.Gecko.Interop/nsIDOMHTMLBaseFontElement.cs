...
namespace DotGecko.Gecko.Interop
{
	 ...
	 * @status FROZEN
	 */
	[ComImport, Guid("a6cf90a6-15b3-11d2-932e-00805f8add32"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	public interface nsIDOMHTMLBaseFontElement : nsIDOMHTMLElement
	{
