...
namespace DotGecko.Gecko.Interop
{
	...
	public delegate nsResult nsWriteSegmentFun(nsIInputStream aInStream, IntPtr aClosure, IntPtr aFromSegment, UInt32 aToOffset, UInt32 aCount, ref UInt32 aWriteCount);
