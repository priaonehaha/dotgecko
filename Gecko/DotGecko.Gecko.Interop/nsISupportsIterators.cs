...
namespace DotGecko.Gecko.Interop
{
	...
	*/
	...
	public interface nsIOutputIterator //: nsISupports
	{
		/**
	...
	public interface nsIInputIterator //: nsISupports
	{
		/**
	...
	public interface nsIForwardIterator //: nsISupports
	{
		/**
		 * Retrieve (and |AddRef()|) the element this iterator currently points to.
		 *
	...
	public interface nsIBidirectionalIterator //: nsISupports
	{
		/**
		 * Retrieve (and |AddRef()|) the element this iterator currently points to.
		 *
	...
	public interface nsIRandomAccessIterator //: nsISupports
	{
		/**
		 * Retrieve (and |AddRef()|) the element this iterator currently points to.
		 *
