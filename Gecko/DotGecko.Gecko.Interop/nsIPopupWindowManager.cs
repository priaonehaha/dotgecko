...
{
	public static class nsIPopupWindowManagerConstants
	{
		/**
		 * These values are returned by the testPermission method
		 */
		public const UInt32 ALLOW_POPUP = 1;
		public const UInt32 DENY_POPUP = 2;
		public const UInt32 ALLOW_POPUP_WITH_PREJUDICE = 3;
	}
	...
	public interface nsIPopupWindowManager //: nsISupports
	{
		/**
