...
{
	public static class nsIAuthInformationConstants
	{
		/** @name Flags */
		/* @{ */
		/**
		 ...
		 */
		public const UInt32 AUTH_HOST = 1;

		/**
		 * This dialog belongs to a proxy.
		 */
		public const UInt32 AUTH_PROXY = 2;
		 ...
		 */
		public const UInt32 NEED_DOMAIN = 4;
	...
	public interface nsIAuthInformation //: nsISupports
	{
		/**
