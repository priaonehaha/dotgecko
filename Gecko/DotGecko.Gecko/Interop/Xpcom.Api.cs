...
namespace DotGecko.Gecko.Interop
{
	internal static partial class Xpcom
	{
		...
		internal struct nsStaticModuleInfo
		{
			internal String name;
			internal nsGetModuleProc getModule;
		}
		 ...
		 */
		internal const UInt32 NS_DEBUG_WARNING = 0;
		internal const UInt32 NS_DEBUG_ASSERTION = 1;
		internal const UInt32 NS_DEBUG_BREAK = 2;
		internal const UInt32 NS_DEBUG_ABORT = 3;
