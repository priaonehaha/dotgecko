...
{
	internal static class nsIWebProgressListenerConstants
	{
		/**
		 ...
		 */
		internal const UInt32 STATE_START = 0x00000001;
		internal const UInt32 STATE_REDIRECTING = 0x00000002;
		internal const UInt32 STATE_TRANSFERRING = 0x00000004;
		internal const UInt32 STATE_NEGOTIATING = 0x00000008;
		internal const UInt32 STATE_STOP = 0x00000010;
		 ...
		 */
		internal const UInt32 STATE_IS_REQUEST = 0x00010000;
		internal const UInt32 STATE_IS_DOCUMENT = 0x00020000;
		internal const UInt32 STATE_IS_NETWORK = 0x00040000;
		internal const UInt32 STATE_IS_WINDOW = 0x00080000;
		 ...
		 */
		internal const UInt32 STATE_RESTORING = 0x01000000;
		 ...
		 */
		internal const UInt32 STATE_IS_INSECURE = 0x00000004;
		internal const UInt32 STATE_IS_BROKEN = 0x00000001;
		internal const UInt32 STATE_IS_SECURE = 0x00000002;
		 ...
		 */
		internal const UInt32 STATE_SECURE_HIGH = 0x00040000;
		internal const UInt32 STATE_SECURE_MED = 0x00010000;
		internal const UInt32 STATE_SECURE_LOW = 0x00020000;
		...
		/**
		  ...
		  */
		internal const UInt32 STATE_IDENTITY_EV_TOPLEVEL = 0x00100000;
	}
	...
	internal interface nsIWebProgressListener //: nsISupports
	{
		/**
