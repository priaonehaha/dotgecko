...
{
	internal static class nsIChannelConstants
	{
		/**************************************************************************
		 ...
		 */
		internal const UInt32 LOAD_DOCUMENT_URI = 1 << 16;

		/** 
		 * If the end consumer for this load has been retargeted after discovering 
		 * its content, this flag will be set:
		 */
		internal const UInt32 LOAD_RETARGETED_DOCUMENT_URI = 1 << 17;
		 ...
		 */
		internal const UInt32 LOAD_CALL_CONTENT_SNIFFERS = 1 << 21;
	}
