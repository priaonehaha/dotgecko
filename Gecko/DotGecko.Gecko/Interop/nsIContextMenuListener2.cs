...
{
	internal static class nsIContextMenuListener2Constants
	{
		/** Flag. No context. */
		internal const UInt32 CONTEXT_NONE = 0;
		/** Flag. Context is a link element. */
		internal const UInt32 CONTEXT_LINK = 1;
		/** Flag. Context is an image element. */
		internal const UInt32 CONTEXT_IMAGE = 2;
		/** Flag. Context is the whole document. */
		internal const UInt32 CONTEXT_DOCUMENT = 4;
		/** Flag. Context is a text area element. */
		internal const UInt32 CONTEXT_TEXT = 8;
		/** Flag. Context is an input element. */
		internal const UInt32 CONTEXT_INPUT = 16;
		/** Flag. Context is a background image. */
		internal const UInt32 CONTEXT_BACKGROUND_IMAGE = 32;
	}
	...
	internal interface nsIContextMenuListener2 //: nsISupports
	{
		/**
	...
	internal interface nsIContextMenuInfo //: nsISupports
	{
		/**
