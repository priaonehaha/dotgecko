...
{
	internal static class nsIWebNavigationConstants
	{
		/****************************************************************************
		 ...
		 */
		internal const UInt32 LOAD_FLAGS_MASK = 0xffff;

		/**
		 * This is the default value for the load flags parameter.
		 */
		internal const UInt32 LOAD_FLAGS_NONE = 0x0000;
		 ...
		 */
		internal const UInt32 LOAD_FLAGS_IS_REFRESH = 0x0010;
		 ...
		 * XXX the meaning of this flag is poorly defined.
		 */
		internal const UInt32 LOAD_FLAGS_IS_LINK = 0x0020;

		/**
		 * This flag specifies that history should not be updated.  This flag is only
		 * applicable to loadURI.
		 */
		internal const UInt32 LOAD_FLAGS_BYPASS_HISTORY = 0x0040;

		/**
		 * This flag specifies that any existing history entry should be replaced.
		 * This flag is only applicable to loadURI.
		 */
		internal const UInt32 LOAD_FLAGS_REPLACE_HISTORY = 0x0080;
		 ...
		 */
		internal const UInt32 LOAD_FLAGS_BYPASS_CACHE = 0x0100;
		 ...
		 */
		internal const UInt32 LOAD_FLAGS_BYPASS_PROXY = 0x0200;
		 ...
		 * document.
		 */
		internal const UInt32 LOAD_FLAGS_CHARSET_CHANGE = 0x0400;
		 ...
		 */
		internal const UInt32 LOAD_FLAGS_STOP_CONTENT = 0x0800;

		/**
		 * A hint this load was prompted by an external program: take care!
		 */
		internal const UInt32 LOAD_FLAGS_FROM_EXTERNAL = 0x1000;
		 ...
		 */
		internal const UInt32 LOAD_FLAGS_ALLOW_THIRD_PARTY_FIXUP = 0x2000;
		 ...
		 */
		internal const UInt32 STOP_NETWORK = 0x01;
		 ...
		 */
		internal const UInt32 STOP_CONTENT = 0x02;

		/**
		 * This flag specifies that all activity should be stopped.
		 */
		internal const UInt32 STOP_ALL = 0x03;
	}
	...
	internal interface nsIWebNavigation //: nsISupports
	{
		/**
