...
{
	internal static class nsIDownloadManagerUIConstants
	{
		/**
		 * The reason that should be passed when the user requests to show the
		 * download manager's UI.
		 */
		internal const Int16 REASON_USER_INTERACTED = 0;
