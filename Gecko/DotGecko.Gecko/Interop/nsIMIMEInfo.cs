...
{
	internal static class nsIHandlerInfoConstants
	{
		internal const Int32 saveToDisk = 0;
		/**
		 * Used to indicate that we know nothing about what to do with this.  You
		 * could consider this to be not initialized.
		 */
		internal const Int32 alwaysAsk = 1;
		internal const Int32 useHelperApp = 2;
		internal const Int32 handleInternally = 3;
		internal const Int32 useSystemDefault = 4;
	}
	...
	internal interface nsIHandlerInfo //: nsISupports
	{
		/**
	...
	internal interface nsIMIMEInfo : nsIHandlerInfo
	{
	...
	internal interface nsIHandlerApp //: nsISupports
	{
		/**
	...
	internal interface nsILocalHandlerApp : nsIHandlerApp
	{
	...
	internal interface nsIWebHandlerApp : nsIHandlerApp
	{
		#region nsIHandlerApp Members
	...
	internal interface nsIDBusHandlerApp : nsIHandlerApp
	{
		#region nsIHandlerApp Members
