...
{
	internal static class nsIClassInfoConstants
	{
		/**
		 * Bitflags for 'flags' attribute.
		 */
		internal const UInt32 SINGLETON = 1 << 0;
		internal const UInt32 THREADSAFE = 1 << 1;
		internal const UInt32 MAIN_THREAD_ONLY = 1 << 2;
		internal const UInt32 DOM_OBJECT = 1 << 3;
		internal const UInt32 PLUGIN_OBJECT = 1 << 4;
		internal const UInt32 EAGER_CLASSINFO = 1 << 5;
		/**
		 * 'flags' attribute bitflag: whether objects of this type implement
		 * nsIContent.
		 */
		internal const UInt32 CONTENT_NODE = 1 << 6;

		// The high order bit is RESERVED for consumers of these flags. 
		// No implementor of this interface should ever return flags 
		// with this bit set.
		internal const UInt32 RESERVED = (UInt32)1 << 31;
	}
	...
	internal interface nsIClassInfo //: nsISupports
	{
		/**
