...
{
	internal static class nsIPrefBranchConstants
	{
		/**
		 ...
		 * @see getPrefType
		 */
		internal const Int32 PREF_INVALID = 0;
		internal const Int32 PREF_STRING = 32;
		internal const Int32 PREF_INT = 64;
		internal const Int32 PREF_BOOL = 128;
	}
	...
	internal interface nsIPrefBranch //: nsISupports
	{
		/**
