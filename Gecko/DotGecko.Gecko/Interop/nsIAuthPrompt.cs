...
{
	internal static class nsIAuthPromptConstants
	{
		internal const UInt32 SAVE_PASSWORD_NEVER = 0;
		internal const UInt32 SAVE_PASSWORD_FOR_SESSION = 1;
		internal const UInt32 SAVE_PASSWORD_PERMANENTLY = 2;
	}
	...
	internal interface nsIAuthPrompt //: nsISupports
	{
		/**
