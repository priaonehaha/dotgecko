...
{
	internal static class nsIDataTypeConstants
	{
		// These MUST match the declarations in xpt_struct.h. 
		// Otherwise the world is likely to explode.   
		// From xpt_struct.h ...
		internal const UInt16 VTYPE_INT8 = 0;             // TD_INT8              = 0,
		internal const UInt16 VTYPE_INT16 = 1;            // TD_INT16             = 1,
		internal const UInt16 VTYPE_INT32 = 2;            // TD_INT32             = 2,
		internal const UInt16 VTYPE_INT64 = 3;            // TD_INT64             = 3,
		internal const UInt16 VTYPE_UINT8 = 4;            // TD_UINT8             = 4,
		internal const UInt16 VTYPE_UINT16 = 5;           // TD_UINT16            = 5,
		internal const UInt16 VTYPE_UINT32 = 6;           // TD_UINT32            = 6,
		internal const UInt16 VTYPE_UINT64 = 7;           // TD_UINT64            = 7,
		internal const UInt16 VTYPE_FLOAT = 8;            // TD_FLOAT             = 8, 
		internal const UInt16 VTYPE_DOUBLE = 9;           // TD_DOUBLE            = 9,
		internal const UInt16 VTYPE_BOOL = 10;            // TD_BOOL              = 10,
		internal const UInt16 VTYPE_CHAR = 11;            // TD_CHAR              = 11,
		internal const UInt16 VTYPE_WCHAR = 12;           // TD_WCHAR             = 12,
		internal const UInt16 VTYPE_VOID = 13;            // TD_VOID              = 13,
		internal const UInt16 VTYPE_ID = 14;              // TD_PNSIID            = 14,
		internal const UInt16 VTYPE_DOMSTRING = 15;       // TD_DOMSTRING         = 15,
		internal const UInt16 VTYPE_CHAR_STR = 16;        // TD_PSTRING           = 16,
		internal const UInt16 VTYPE_WCHAR_STR = 17;       // TD_PWSTRING          = 17,
		internal const UInt16 VTYPE_INTERFACE = 18;       // TD_INTERFACE_TYPE    = 18,
		internal const UInt16 VTYPE_INTERFACE_IS = 19;    // TD_INTERFACE_IS_TYPE = 19,
		internal const UInt16 VTYPE_ARRAY = 20;           // TD_ARRAY             = 20,
		internal const UInt16 VTYPE_STRING_SIZE_IS = 21;  // TD_PSTRING_SIZE_IS   = 21,
		internal const UInt16 VTYPE_WSTRING_SIZE_IS = 22; // TD_PWSTRING_SIZE_IS  = 22,
		internal const UInt16 VTYPE_UTF8STRING = 23;      // TD_UTF8STRING        = 23,
		internal const UInt16 VTYPE_CSTRING = 24;         // TD_CSTRING           = 24,
		internal const UInt16 VTYPE_ASTRING = 25;         // TD_ASTRING           = 25,
		internal const UInt16 VTYPE_EMPTY_ARRAY = 254;
		internal const UInt16 VTYPE_EMPTY = 255;
	}

	/* The long avoided variant support for xpcom. */
	[ComImport, Guid("4d12e540-83d7-11d5-90ed-0010a4e73d9a"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	internal interface nsIDataType //: nsISupports
	{
	}
	...
	internal interface nsIVariant //: nsISupports
	{
		UInt16 DataType { get; }
	...
	internal interface nsIWritableVariant : nsIVariant
	{
