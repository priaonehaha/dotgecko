...
{
	internal static class nsIPromptServiceConstants
	{
		/**
		 * Button Flags
		 *
		 ...
		 */
		internal const UInt32 BUTTON_POS_0 = 1;
		internal const UInt32 BUTTON_POS_1 = 1 << 8;
		internal const UInt32 BUTTON_POS_2 = 1 << 16;

		/**
		 * Button Title Flags (used to set the labels of buttons in the prompt)
		 */
		internal const UInt32 BUTTON_TITLE_OK = 1;
		internal const UInt32 BUTTON_TITLE_CANCEL = 2;
		internal const UInt32 BUTTON_TITLE_YES = 3;
		internal const UInt32 BUTTON_TITLE_NO = 4;
		internal const UInt32 BUTTON_TITLE_SAVE = 5;
		internal const UInt32 BUTTON_TITLE_DONT_SAVE = 6;
		internal const UInt32 BUTTON_TITLE_REVERT = 7;
		internal const UInt32 BUTTON_TITLE_IS_STRING = 127;

		/**
		 * Button Default Flags (used to select which button is the default one)
		 */
		internal const UInt32 BUTTON_POS_0_DEFAULT = 0;
		internal const UInt32 BUTTON_POS_1_DEFAULT = 1 << 24;
		internal const UInt32 BUTTON_POS_2_DEFAULT = 1 << 25;
		 ...
		 * this flag.
		 */
		internal const UInt32 BUTTON_DELAY_ENABLE = 1 << 26;

		/**
		 * Selects the standard set of OK/Cancel buttons.
		 */
		internal const UInt32 STD_OK_CANCEL_BUTTONS = (BUTTON_TITLE_OK * BUTTON_POS_0) + (BUTTON_TITLE_CANCEL * BUTTON_POS_1);

		/**
		 * Selects the standard set of Yes/No buttons.
		 */
		internal const UInt32 STD_YES_NO_BUTTONS = (BUTTON_TITLE_YES * BUTTON_POS_0) + (BUTTON_TITLE_NO * BUTTON_POS_1);
	}
	...
	internal interface nsIPromptService //: nsISupports
	{
		/**
