...
{
	internal static class nsIProtocolHandlerConstants
	{
		/**************************************************************************
		 ...
		 * URIs (http, ftp, ...)
		 */
		internal const UInt32 URI_STD = 0;

		/**
		 * no concept of relative URIs (about, javascript, finger, ...)
		 */
		internal const UInt32 URI_NORELATIVE = (1 << 0);

		/**
		 * no authority component (file, ...)
		 */
		internal const UInt32 URI_NOAUTH = (1 << 1);
		 ...
		 */
		internal const UInt32 URI_INHERITS_SECURITY_CONTEXT = (1 << 4);
		 ...
		 */
		internal const UInt32 URI_FORBIDS_AUTOMATIC_DOCUMENT_REPLACEMENT = (1 << 5);
		 ...
		 */
		internal const UInt32 URI_LOADABLE_BY_ANYONE = (1 << 6);
		 ...
		 * this flag.
		 */
		internal const UInt32 URI_DANGEROUS_TO_LOAD = (1 << 7);
		 ...
		 */
		internal const UInt32 URI_IS_UI_RESOURCE = (1 << 8);
		 ...
		 */
		internal const UInt32 URI_DOES_NOT_RETURN_DATA = (1 << 11);
		 ...
		 */
		internal const UInt32 URI_IS_LOCAL_RESOURCE = (1 << 12);

		/**
		 * URIs for this protocol execute script when they are opened.
		 */
		internal const UInt32 URI_OPENING_EXECUTES_SCRIPT = (1 << 13);
		 ...
		 */
		internal const UInt32 ALLOWS_PROXY = (1 << 2);
		 ...
		 */
		internal const UInt32 ALLOWS_PROXY_HTTP = (1 << 3);
	}
	...
	internal interface nsIProtocolHandler //: nsISupports
	{
		/**
