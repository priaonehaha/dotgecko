...
{
	[ComImport, Guid("66f6b992-e2d3-43da-ba2a-d966e34a7654"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	internal interface nsIFaviconService //: nsISupports
	{
		/**
		 ...
		 */
		void SetAndLoadFaviconForPage(nsIURI aPageURI, nsIURI aFaviconURI, Boolean aForceReload);
		...
		void SetFaviconData(nsIURI aFaviconURI,
							[MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U1, SizeParamIndex = 2)] Byte[] aData,
							UInt32 aDataLen,
		 ...
		 *         Thrown if the favicon is overbloated and won't be saved to the db.
		 */
		void SetFaviconDataFromDataURL(nsIURI aFaviconURI, [In, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(AStringMarshaler))] String aDataURL, PRTime aExpiration);
