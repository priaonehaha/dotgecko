...
{
	internal static class nsIDocShellConstants
	{
		internal const Int32 INTERNAL_LOAD_FLAGS_NONE = 0x0;
		internal const Int32 INTERNAL_LOAD_FLAGS_INHERIT_OWNER = 0x1;
		internal const Int32 INTERNAL_LOAD_FLAGS_DONT_SEND_REFERRER = 0x2;
		internal const Int32 INTERNAL_LOAD_FLAGS_ALLOW_THIRD_PARTY_FIXUP = 0x4;

		// This flag marks the first load in this object
		// @see nsIWebNavigation::LOAD_FLAGS_FIRST_LOAD
		internal const Int32 INTERNAL_LOAD_FLAGS_FIRST_LOAD = 0x8;

		internal const Int32 INTERNAL_LOAD_FLAGS_BYPASS_CLASSIFIER = 0x10;
		internal const Int32 INTERNAL_LOAD_FLAGS_FORCE_ALLOW_COOKIES = 0x20;

		internal const Int32 ENUMERATE_FORWARDS = 0;
		internal const Int32 ENUMERATE_BACKWARDS = 1;

		/**
		 * The type of application that created this window
		 */
		internal const UInt32 APP_TYPE_UNKNOWN = 0;
		internal const UInt32 APP_TYPE_MAIL = 1;
		internal const UInt32 APP_TYPE_EDITOR = 2;

		/**
		 * Current busy state for DocShell
		 */
		internal const UInt32 BUSY_FLAGS_NONE = 0;
		internal const UInt32 BUSY_FLAGS_BUSY = 1;
		internal const UInt32 BUSY_FLAGS_BEFORE_PAGE_LOAD = 2;
		internal const UInt32 BUSY_FLAGS_PAGE_LOADING = 4;

		/**
		 * Load commands for the document 
		 */
		internal const UInt32 LOAD_CMD_NORMAL = 0x1; // Normal load
		internal const UInt32 LOAD_CMD_RELOAD = 0x2; // Reload
		internal const UInt32 LOAD_CMD_HISTORY = 0x4; // Load from history
	}
