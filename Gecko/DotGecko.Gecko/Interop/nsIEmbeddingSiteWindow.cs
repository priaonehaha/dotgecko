...
namespace DotGecko.Gecko.Interop
{
	...
	internal static class nsIEmbeddingSiteWindowConstants
	{
		/**
		 ...
		 * @see getDimensions
		 */
		internal const UInt32 DIM_FLAGS_POSITION = 1;
		 ...
		 */
		internal const UInt32 DIM_FLAGS_SIZE_INNER = 2;
		 ...
		 */
		internal const UInt32 DIM_FLAGS_SIZE_OUTER = 4;
	}
