...
{
	internal static class nsIDOMEventConstants
	{
		// PhaseType
		/**
		 * The current event phase is the capturing phase.
		 */
		internal const UInt16 CAPTURING_PHASE = 1;

		/**
		 * The event is currently being evaluated at the target EventTarget.
		 */
		internal const UInt16 AT_TARGET = 2;

		/**
		 * The current event phase is the bubbling phase.
		 */
		internal const UInt16 BUBBLING_PHASE = 3;
	}
	...
	internal interface nsIDOMEvent //: nsISupports
	{
		/**
