...
{
	internal static class nsIPrincipalConstants
	{
		/**
		 ...
		 */
		internal const Int16 ENABLE_DENIED = 1;
		internal const Int16 ENABLE_UNKNOWN = 2;
		internal const Int16 ENABLE_WITH_USER_PERMISSION = 3;
		internal const Int16 ENABLE_GRANTED = 4;
	}

	/* Defines the abstract interface for a principal. */
	[ComImport, Guid("b8268b9a-2403-44ed-81e3-614075c92034"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	internal interface nsIPrincipal : nsISerializable
	{
