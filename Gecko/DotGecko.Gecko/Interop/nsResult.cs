...
{
	internal static class nsResultExtensions
	{
		/**
		...
		internal const UInt32 NS_ERROR_MODULE_XPCOM = 1;
		internal const UInt32 NS_ERROR_MODULE_BASE = 2;
		internal const UInt32 NS_ERROR_MODULE_GFX = 3;
		internal const UInt32 NS_ERROR_MODULE_WIDGET = 4;
		internal const UInt32 NS_ERROR_MODULE_CALENDAR = 5;
		internal const UInt32 NS_ERROR_MODULE_NETWORK = 6;
		internal const UInt32 NS_ERROR_MODULE_PLUGINS = 7;
		internal const UInt32 NS_ERROR_MODULE_LAYOUT = 8;
		internal const UInt32 NS_ERROR_MODULE_HTMLPARSER = 9;
		internal const UInt32 NS_ERROR_MODULE_RDF = 10;
		internal const UInt32 NS_ERROR_MODULE_UCONV = 11;
		internal const UInt32 NS_ERROR_MODULE_REG = 12;
		internal const UInt32 NS_ERROR_MODULE_FILES = 13;
		internal const UInt32 NS_ERROR_MODULE_DOM = 14;
		internal const UInt32 NS_ERROR_MODULE_IMGLIB = 15;
		internal const UInt32 NS_ERROR_MODULE_MAILNEWS = 16;
		internal const UInt32 NS_ERROR_MODULE_EDITOR = 17;
		internal const UInt32 NS_ERROR_MODULE_XPCONNECT = 18;
		internal const UInt32 NS_ERROR_MODULE_PROFILE = 19;
		internal const UInt32 NS_ERROR_MODULE_LDAP = 20;
		internal const UInt32 NS_ERROR_MODULE_SECURITY = 21;
		internal const UInt32 NS_ERROR_MODULE_DOM_XPATH = 22;
		internal const UInt32 NS_ERROR_MODULE_DOM_RANGE = 23;
		internal const UInt32 NS_ERROR_MODULE_URILOADER = 24;
		internal const UInt32 NS_ERROR_MODULE_CONTENT = 25;
		internal const UInt32 NS_ERROR_MODULE_PYXPCOM = 26;
		internal const UInt32 NS_ERROR_MODULE_XSLT = 27;
		internal const UInt32 NS_ERROR_MODULE_IPC = 28;
		internal const UInt32 NS_ERROR_MODULE_SVG = 29;
		internal const UInt32 NS_ERROR_MODULE_STORAGE = 30;
		internal const UInt32 NS_ERROR_MODULE_SCHEMA = 31;
		internal const UInt32 NS_ERROR_MODULE_DOM_FILE = 32;
		 ...
		 * the generic base.
		 */
		internal const UInt32 NS_ERROR_MODULE_GENERAL = 51;

		/**
		 * @name Severity Code.  This flag identifies the level of warning
		 */

		internal const UInt32 NS_ERROR_SEVERITY_SUCCESS = 0;
		internal const UInt32 NS_ERROR_SEVERITY_ERROR = 1;
		...
		internal static Boolean NS_FAILED(this nsResult nsresult)
		{
			return ((UInt32)nsresult & 0x80000000) != 0;
		}

		internal static Boolean NS_SUCCEEDED(this nsResult nsresult)
		{
			return ((UInt32)nsresult & 0x80000000) == 0;
		}
		...
		internal const UInt32 NS_ERROR_MODULE_BASE_OFFSET = 0x45;

		/**
		 * @name Standard Error Generating Macros
		 */

		internal static nsResult NS_ERROR_GENERATE(UInt32 sev, UInt32 module, UInt32 code)
		{
			return (nsResult)((sev << 31) | ((module + NS_ERROR_MODULE_BASE_OFFSET) << 16) | code);
		}

		internal static nsResult NS_ERROR_GENERATE_SUCCESS(UInt32 module, UInt32 code)
		{
			return NS_ERROR_GENERATE(NS_ERROR_SEVERITY_SUCCESS, module, code);
		}

		internal static nsResult NS_ERROR_GENERATE_FAILURE(UInt32 module, UInt32 code)
		{
		...
		internal static UInt32 NS_ERROR_GET_CODE(this nsResult nsresult)
		{
			return (UInt32)nsresult & 0xffff;
		}

		internal static UInt32 NS_ERROR_GET_MODULE(this nsResult nsresult)
		{
			return (((UInt32)nsresult >> 16) - NS_ERROR_MODULE_BASE_OFFSET) & 0x1fff;
		}

		internal static UInt32 NS_ERROR_GET_SEVERITY(this nsResult nsresult)
		{
			return ((UInt32)nsresult >> 31) & 0x1;
		}
	}

	internal enum nsResult : uint
	{
