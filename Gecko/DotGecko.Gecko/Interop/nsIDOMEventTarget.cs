...
namespace DotGecko.Gecko.Interop
{
	 ...
	 * @status FROZEN
	 */
	[ComImport, Guid("1c773b30-d1cf-11d2-bd95-00805f8ae3f4"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	internal interface nsIDOMEventTarget //: nsISupports
	{
		/**
		 ...
		 */
		void AddEventListener([In, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DOMStringMarshaler))] String type, nsIDOMEventListener listener, Boolean useCapture);
		 ...
		 */
		void RemoveEventListener([In, MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(DOMStringMarshaler))] String type, nsIDOMEventListener listener, Boolean useCapture);
		 ...
		 *              exception.
		 */
		Boolean DispatchEvent(nsIDOMEvent evt); //raises(DOMException);
	}
}
