...
{
	internal static class nsIDocShellLoadInfoConstants
	{
		/* these are load type enums... */
		internal const Int32 loadNormal = 0;                     // Normal Load
		internal const Int32 loadNormalReplace = 1;              // Normal Load but replaces current history slot
		internal const Int32 loadHistory = 2;                    // Load from history
		internal const Int32 loadReloadNormal = 3;               // Reload
		internal const Int32 loadReloadBypassCache = 4;
		internal const Int32 loadReloadBypassProxy = 5;
		internal const Int32 loadReloadBypassProxyAndCache = 6;
		internal const Int32 loadLink = 7;
		internal const Int32 loadRefresh = 8;
		internal const Int32 loadReloadCharsetChange = 9;
		internal const Int32 loadBypassHistory = 10;
		internal const Int32 loadStopContent = 11;
		internal const Int32 loadStopContentAndReplace = 12;
		internal const Int32 loadNormalExternal = 13;
		internal const Int32 loadNormalBypassCache = 14;
		internal const Int32 loadNormalBypassProxy = 15;
		internal const Int32 loadNormalBypassProxyAndCache = 16;
	}
