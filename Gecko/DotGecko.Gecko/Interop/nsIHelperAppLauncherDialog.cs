...
{
	internal static class nsIHelperAppLauncherDialogConstants
	{
		/**
		 * This request is passed to the helper app dialog because Gecko can not
		 * handle content of this type.
		 */
		internal const Int32 REASON_CANTHANDLE = 0;

		/**
		 * The server requested external handling.
		 */
		internal const Int32 REASON_SERVERREQUEST = 1;

		/**
		 * Gecko detected that the type sent by the server (e.g. text/plain) does
		 * not match the actual type.
		 */
		internal const Int32 REASON_TYPESNIFFED = 2;
	}
	...
	internal interface nsIHelperAppLauncherDialog //: nsISupports
	{
		/**
