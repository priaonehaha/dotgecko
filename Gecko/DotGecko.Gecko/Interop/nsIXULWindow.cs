...
{
	internal static class nsIXULWindowConstants
	{
		internal const UInt32 lowestZ = 0;
		internal const UInt32 loweredZ = 4;  /* "alwaysLowered" attribute */
		internal const UInt32 normalZ = 5;
		internal const UInt32 raisedZ = 6;   /* "alwaysRaised" attribute */
		internal const UInt32 highestZ = 9;
	}
	...
	internal interface nsIXULWindow //: nsISupports
	{
		/**
