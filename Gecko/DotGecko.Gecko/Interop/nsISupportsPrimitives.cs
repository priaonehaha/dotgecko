...
{
	internal static class nsISupportsPrimitiveConstants
	{
		internal const UInt16 TYPE_ID = 1;
		internal const UInt16 TYPE_CSTRING = 2;
		internal const UInt16 TYPE_STRING = 3;
		internal const UInt16 TYPE_PRBOOL = 4;
		internal const UInt16 TYPE_PRUINT8 = 5;
		internal const UInt16 TYPE_PRUINT16 = 6;
		internal const UInt16 TYPE_PRUINT32 = 7;
		internal const UInt16 TYPE_PRUINT64 = 8;
		internal const UInt16 TYPE_PRTIME = 9;
		internal const UInt16 TYPE_CHAR = 10;
		internal const UInt16 TYPE_PRINT16 = 11;
		internal const UInt16 TYPE_PRINT32 = 12;
		internal const UInt16 TYPE_PRINT64 = 13;
		internal const UInt16 TYPE_FLOAT = 14;
		internal const UInt16 TYPE_DOUBLE = 15;
		internal const UInt16 TYPE_VOID = 16;
		internal const UInt16 TYPE_INTERFACE_POINTER = 17;
	}
	...
	internal interface nsISupportsPrimitive //: nsISupports
	{
		UInt16 Type { get; }
	}
	...
	internal interface nsISupportsID : nsISupportsPrimitive
	{
	...
	internal interface nsISupportsCString : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsString : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRBool : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRUint8 : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRUint16 : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRUint32 : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRUint64 : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRTime : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsChar : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRInt16 : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRInt32 : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsPRInt64 : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsFloat : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsDouble : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsVoid : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
	...
	internal interface nsISupportsInterfacePointer : nsISupportsPrimitive
	{
		#region nsISupportsPrimitive Members
